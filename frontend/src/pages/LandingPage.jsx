...
import { Sparkles, ChevronDown, Wand2, Calculator, Calendar, Plane } from 'lucide-react'
...
export function LandingPage() {
    ...
    return (
        <div className="relative min-h-screen flex flex-col items-center justify-center px-4 bg-black overflow-hidden pt-20">
                ...
                >
                    {[
                        ...
                        <motion.div
                            ...
                            className="p-6 rounded-2xl bg-zinc-900/80 border border-white/20 text-left hover:border-white/50 transition-all cursor-default backdrop-blur-md shadow-xl"
                        >
